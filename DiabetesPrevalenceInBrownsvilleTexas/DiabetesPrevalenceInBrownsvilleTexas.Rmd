...
#### Multiple Visit Data ####
datamult<-data.frame(
  id=sample(0:1000,3000,replace=T),
  visitdate=sample(seq(as.Date("2004-01-01"),as.Date("2018-12-31"),by="day"),
                   3000,replace=T),
  age=sample(18:100,3000,replace=T),
  insure=sample(0:1,3000,replace=T),
  employ=sample(0:1,3000,replace=T),
  diabetes=sample(0:1,3000,replace=T))
